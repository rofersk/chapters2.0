    ...
    <div class="bg-gray-900 min-h-screen flex items-center justify-center">
      <div
        class="
          ...
          max-w-6xl
          sm:p-6 sm:my-2 sm:mx-4 sm:rounded-2xl
        "
      >
        <!-- Navigation -->
        <div
        ...
        >
          <nav
            class="
              ...
              flex-row
              space-x-2
              lg:space-x-0 lg:flex-col lg:space-y-2
            "
          >
            <a
              class="
          ...
          >
            <div
              class="
                ...
                cursor-pointer
                rounded-md
                hover:bg-gray-900/40 hover:smooth-hover
              "
            >
              <a
                class="
                  bg-gray-900/70
                  text-white/50
                  group-hover:text-white group-hover:smooth-hover
                  flex
                  w-20
                  h-20
                  rounded-full
            ...
            <div
              class="
                ...
                cursor-pointer
                rounded-md
                hover:bg-gray-900/80 hover:smooth-hover
              "
            >
              <img
